...
The current version is 1.0.1, which includes some missing support files for Scrivener for Windows.
...
* Using [Paloma](./paloma/) (a Jonah-like format for Twine 2): [test-paloma.html](test-paloma.html)
