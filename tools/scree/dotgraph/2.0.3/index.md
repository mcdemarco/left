...
The is an archived version of DotGraph 2.0.3, which counted and styled unreachable passages.  Previous versions are archived [here](/tools/scree/dotgraph/versions.html).
