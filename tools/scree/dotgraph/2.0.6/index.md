...
This is an archived version of DotGraph is 2.0.6, which added display macro support for Harlowe and fixes a leaf counting issue.  Previous versions are archived [here](/tools/scree/dotgraph/versions.html).
