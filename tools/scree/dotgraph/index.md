...
The current version of DotGraph is 2.0.0, which includes support for Twine 1, offline use, omitting special passages, and renumbering nodes.  Previous versions are archived [here](versions).
...
To add DotGraph to Twine 1, create a new folder called `dotgraph` inside your targets folder, then download this file: [https://mcdemarco.net/tools/scree/dotgraph/header.html](https://mcdemarco.net/tools/scree/dotgraph/header.html) and place it inside the `dotgraph` folder.  For offline use, download and use [https://mcdemarco.net/tools/scree/dotgraph/offline/header.html](https://mcdemarco.net/tools/scree/dotgraph/header.html) instead.
...
![small example](/tools/scree/dotgraph/icon.svg)
