...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Almanac = __webpack_require__(159);

	var _Almanac2 = _interopRequireDefault(_Almanac);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	_reactDom2.default.render(_react2.default.createElement(_Almanac2.default, null), document.querySelector('#content'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Tags = __webpack_require__(179);

	var _Ratings = __webpack_require__(180);

	var _Util = __webpack_require__(181);

	var _Random = __webpack_require__(182);

	var _Random2 = _interopRequireDefault(_Random);

	var _World = __webpack_require__(183);

	var _World2 = _interopRequireDefault(_World);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var Almanac = _react2.default.createClass({
	  displayName: 'Almanac',
	  getInitialState: function getInitialState() {
	    var initOrder = (0, _lodash2.default)(_Layout.count); // index: visual position. value: component key/id
	    var initHash = this.validWorld(window.location.hash.substring(1, 4));
	    var hashOrder = this.getOrderFromHash(initOrder, initHash);
	    return {
	      mouse: [0, 0],
	  ...
	  validWorld: function validWorld(world) {
	    {/*Don't attempt to process an illegal world name:
	      ...
	      */}
	    if (/[1-9x]{3}/.test(world) && !/([1-9])\1{1,}/.test(world) && (world[0] != world[2] || world[0] == "x")) return world;else return "123";
	  },
	  getOrderFromHash: function getOrderFromHash(order, world) {
	    var worldClean = world.split("").map(function (curr, indx) {
	      return curr == "x" ? indx + 9 : parseInt(curr, 10) - 1;
	    });
	    var hashOrder = undefined;
	    hashOrder = (0, _Util.reinsert)(order, order.indexOf(worldClean[0]), 0);
	    hashOrder = (0, _Util.reinsert)(hashOrder, hashOrder.indexOf(worldClean[1]), 1);
	    hashOrder = (0, _Util.reinsert)(hashOrder, hashOrder.indexOf(worldClean[2]), 2);
	    return hashOrder;
	  },
	  ...
	  handleHashChange: function handleHashChange() {
	    ...
	    var updatedHash = this.validWorld(window.location.hash.substring(1, 4));
	    var updatedOrder = this.getOrderFromHash(order, updatedHash);
	    this.setState({ order: updatedOrder, hash: updatedHash });
	  },
	  handleKeyDown: function handleKeyDown(e) {
	    var dialPosition = this.state.dialPosition;
	  ...
	  handleMouseMove: function handleMouseMove(_ref) {
	    ...
	    if (isPressed) {
	      ...
	      var col = this.clamp(Math.floor(mouse[0] / _Layout.width), 0, 2);
	      var row = this.clamp(Math.floor(mouse[1] / _Layout.height), 0, Math.floor(_Layout.count / 3));
	      var index = row * 3 + col;
	      var newOrder = (0, _Util.reinsert)(order, order.indexOf(lastPress), index);
	      var newHash = (0, _Util.getHashFromOrder)(newOrder);
	  ...
	  dial: function dial(number) {
	    ...
	    var dialPosition = _state2.dialPosition;

	    var newOrder = (0, _Util.reinsert)(order, order.indexOf(number), dialPosition);
	    var newHash = (0, _Util.getHashFromOrder)(newOrder);
	    var newDial = (dialPosition + 1) % 3;
	    this.setState({ order: newOrder, hash: newHash, dialPosition: newDial });
	  },
	  switchWorld: function switchWorld(newWorldOrder) {
	    {/* Help push to state from the Random class. */}
	    var newWorldHash = (0, _Util.getHashFromOrder)(newWorldOrder);
	  ...
	  render: function render() {
	    ...
	    var lastPress = _state3.lastPress;
	    var isPressed = _state3.isPressed;
	    ...
	    return _react2.default.createElement(
	        ...
	        order.map(function (_, key) {
	          ...
	          if (key === lastPress && isPressed) {
	            ...
	            style = {
	              translateX: x,
	              translateY: y,
	              scale: (0, _reactMotion.spring)(1.2, [180, 10]),
	              boxShadow: (0, _reactMotion.spring)((x - (3 * _Layout.width - 50) / 2) / 15, [180, 10])
	            };
	          } else {
	            var _layout$visualPositio = _slicedToArray(_Layout.layout[visualPosition], 2);

	            x = _layout$visualPositio[0];
	            y = _layout$visualPositio[1];

	            style = {
	              translateX: (0, _reactMotion.spring)(x, [120, 17]),
	              translateY: (0, _reactMotion.spring)(y, [120, 17]),
	              scale: (0, _reactMotion.spring)(1, [180, 10]),
	              boxShadow: (0, _reactMotion.spring)((x - (3 * _Layout.width - 50) / 2) / 15, [180, 10])
	            };
	          }
	          return _react2.default.createElement(
	            ...
	            function (_ref5) {
	              ...
	              return _react2.default.createElement(
	                'div',
	                {
	                  ...
	                  title: _Modules.modules[key],
	                  style: {
	                    backgroundColor: _Modules.allColors[key],
	                    color: _Modules.contrastColors[key],
	                ...
	                _react2.default.createElement(
	                  'div',
	                  { className: key < 9 ? "icon" : "noIcon" },
	                  key < 9 ? key + 1 : "x"
	                ),
	                _react2.default.createElement(
	                  'div',
	                  null,
	                  _react2.default.createElement('i', { className: "fa fa-" + _Modules.icons[key] })
	                )
	              );
	            }
	          );
	      ...
	      _react2.default.createElement(_Random2.default, { order: order, worldNo: hash, switchWorld: this.switchWorld, ref: 'random' }),
	      _react2.default.createElement(_World2.default, { world: order.slice(0, 3), worldNo: hash, key: hash })
	    );
	  }
	});
...
/***/ function(module, exports) {
	...
	var allColors = exports.allColors = ['#97b911', '#009ee0', '#007930', '#a7d6c9', '#cd071e', '#ffed00', '#e06c9e', '#f7a800', '#972f86'];
	var contrastColors = exports.contrastColors = ['black', 'black', 'white', 'black', 'white', 'black', 'black', 'black', 'white', 'black', 'black', 'black'];
	var icons = exports.icons = ['truck', 'flag-checkered', 'plus-square', 'crosshairs', 'compass', 'road', 'bar-chart', 'industry', 'money'];
	var modules = exports.modules = ['Pick-Up & Deliver', 'Race', 'Privileges', 'Military', 'Exploration', 'Roads', 'Majorities', 'Production', 'Shares', '____', '____', '____'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.buttons = exports.layout = exports.height = exports.width = exports.count = undefined;
	...
	var layout = exports.layout = (0, _lodash2.default)(count).map(function (n) {
	  var row = Math.floor(n / 3);
	  var col = n % 3;
	  return [width * col, height * row];
	});
	var buttons = exports.buttons = [{ name: "bestOf", title: "Highly-rated worlds", icon: "fa fa-star" }, { name: "worstOf", title: "Poorly-rated worlds", icon: "fa fa-star-o" }, { name: "random", title: "Random worlds", icon: "fa fa-random" }, { name: "tagged", title: "Tagged worlds", icon: "fa fa-tag" }, { name: "unexplored", title: "Unexplored worlds", icon: "fa fa-safari" }];
...
/***/ function(module, exports) {
	...
	{/* Generated manually with help from the script in the utils directory. */}

	var ratings = exports.ratings = { "123": 6, "124": 6, "125": 6, "126": 7, "127": 6, "128": 6, "129": 6, "132": 7, "135": 9, "152": 6, "154": 6, "156": 7, "158": 4, "162": 7, "163": 7, "165": 7, "167": 8, "168": 8, "169": 5, "172": 9, "176": 6, "178": 7, "189": 7, "213": 6, "214": 7, "215": 7, "219": 3, "231": 6, "234": 7, "237": 8, "238": 7, "243": 5, "245": 6, "247": 7, "251": 5, "253": 3, "254": 7, "256": 6, "257": 6, "259": 6, "261": 6, "263": 7, "267": 6, "273": 10, "274": 7, "275": 7, "279": 6, "283": 5, "284": 7, "286": 8, "289": 5, "291": 8, "293": 6, "296": 8, "314": 7, "318": 6, "345": 7, "352": 7, "359": 6, "361": 6, "365": 7, "367": 9, "368": 6, "369": 7, "372": 7, "375": 4, "378": 7, "385": 7, "387": 7, "391": 5, "396": 6, "429": 7, "435": 8, "438": 8, "451": 7, "453": 5, "456": 6, "463": 8, "467": 7, "468": 7, "471": 7, "473": 2, "478": 7, "482": 2, "486": 9, "487": 3, "497": 6, "513": 6, "514": 6, "516": 7, "518": 8, "523": 7, "524": 5, "529": 7, "531": 7, "538": 7, "562": 7, "563": 4, "564": 6, "567": 8, "571": 4, "572": 3, "573": 4, "574": 5, "576": 4, "578": 8, "579": 4, "582": 8, "583": 8, "586": 6, "591": 6, "593": 6, "612": 9, "617": 7, "618": 9, "619": 7, "621": 7, "623": 6, "629": 4, "631": 6, "635": 7, "645": 7, "651": 3, "653": 6, "657": 7, "658": 8, "671": 5, "672": 6, "673": 5, "678": 7, "682": 7, "683": 7, "684": 6, "685": 7, "723": 7, "726": 7, "728": 8, "729": 6, "732": 7, "735": 5, "738": 9, "743": 8, "746": 8, "748": 5, "753": 5, "754": 7, "762": 4, "763": 7, "764": 6, "783": 6, "785": 4, "789": 7, "812": 7, "813": 8, "816": 7, "817": 7, "826": 5, "832": 7, "835": 7, "846": 9, "852": 7, "853": 7, "854": 6, "856": 6, "857": 8, "861": 8, "863": 7, "865": 7, "871": 7, "872": 7, "879": 7, "891": 7, "892": 7, "897": 9, "912": 7, "914": 7, "915": 7, "921": 9, "925": 8, "926": 6, "928": 9, "941": 7, "942": 9, "943": 7, "945": 9, "948": 7, "956": 6, "963": 9, "971": 7, "976": 4, "978": 7, "981": 9, "984": 9, "985": 9, "986": 8, "987": 7 };
...
/***/ function(module, exports) {
	...
	exports.getHashFromOrder = getHashFromOrder;
	...
	function getHashFromOrder(order) {
	  return order.slice(0, 3).map(function (a) {
	    return a < 9 ? a + 1 : "x";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Random = _react2.default.createClass({
		displayName: 'Random',
		getComponent: function getComponent(button) {
			this.getNewWorld(button.name);
		},
		getNewWorld: function getNewWorld(ofType) {
			{/* Find a world of the specified type. */}
			var order = this.props.order;

			var newWorldOrder = this.randomizer(order);
			var newWorldHash = (0, _Util.getHashFromOrder)(newWorldOrder);
			if (!this.worldTest(newWorldHash, ofType)) this.getNewWorld(ofType);else this.switcher(newWorldOrder);
		},
		worldTest: function worldTest(hash, ofType) {
			switch (ofType) {
				case "random":
					return true;
				case "bestOf":
		...
		isBad: function isBad(hash) {
			{/* Check if the current world is poorly rated. */}
			return _Ratings.ratings.hasOwnProperty(hash) && _Ratings.ratings[hash] < 6 && _Ratings.ratings[hash] > 0;
		},
		isGood: function isGood(hash) {
			{/* Check if the current world is highly rated. */}
			return _Ratings.ratings.hasOwnProperty(hash) && _Ratings.ratings[hash] >= 7;
		},
		isUnexplored: function isUnexplored(hash) {
			{/* Check if the current world is explored (has tags or votes). */}
			return !(_Tags.tags.hasOwnProperty(hash) || _Ratings.ratings.hasOwnProperty(hash));
		},
		isTagged: function isTagged(hash) {
			{/* Check if the current world has tags. */}
			return _Tags.tags.hasOwnProperty(hash);
		},
		randomizer: function randomizer(order) {
			{/* Randomize to a real world. */}
			var newWorld = undefined;
			var newWorldOrder = undefined;
			newWorld = Math.floor(Math.random() * 9);
			newWorldOrder = (0, _Util.reinsert)(order, order.indexOf(newWorld), 0);
			newWorld = Math.floor(Math.random() * 9);
			newWorldOrder = (0, _Util.reinsert)(newWorldOrder, newWorldOrder.indexOf(newWorld), 0);
			newWorld = Math.floor(Math.random() * 9);
			newWorldOrder = (0, _Util.reinsert)(newWorldOrder, newWorldOrder.indexOf(newWorld), 0);
			return newWorldOrder;
		},
		switcher: function switcher(newWorldOrder) {
		...
		render: function render() {
			...
			return _react2.default.createElement(
				'div',
				{ className: 'worldRandomizer' },
				_Layout.buttons.map(function (b) {
					return _react2.default.createElement(
						'span',
						{ key: b.name, title: b.title, onClick: _this.getComponent.bind(_this, b) },
						_react2.default.createElement('i', { className: b.icon })
					);
				})
			);
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Names = __webpack_require__(184);
	...
	var World = _react2.default.createClass({
		displayName: 'World',
		convertToWorldName: function convertToWorldName(w) {
			return w.reduce(function (prev, valu, indx) {
				return prev + " " + _Names.names[indx][valu];
			}, "");
		},
		convertToWorldModules: function convertToWorldModules(w) {
			return w.reduce(function (prev, valu, indx) {
				return prev + (indx > 0 ? ", " : "") + _Modules.modules[valu];
			}, "");
		},
		typeWorld: function typeWorld(w) {
			if (w[0] < 9 && w[1] < 9 && w[2] < 9) return "full";else if (w[0] < 9 && w[1] < 9 || w[0] < 9 && w[2] > 8 || w[1] > 8 && w[2] > 8) return "partial";else return "weird";
		},
		render: function render() {
			var _props = this.props;
			var world = _props.world;
			var worldNo = _props.worldNo;

			var worldType = this.typeWorld(world);
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					'h2',
					null,
					this.convertToWorldName(world)
				),
				_react2.default.createElement(
					'h3',
					null,
					this.convertToWorldModules(world)
				),
				_react2.default.createElement(_Link2.default, { world: world, worldNo: worldNo, worldType: worldType })
			);
		}
	});
...
/***/ function(module, exports) {
	...
	var names = exports.names = [["The World of Traveling", "The World of Restless", "The World of Individual", "The World of Combative", "The World of Exploring", "The World of Networking", "The World of the Mightiest", "The World of Productive", "A World of Publicly Owned", "A World of ____", "A World of ____", "A World of ____"], ["Traders", "Pioneers", "Industrialists", "Generals", "Explorers", "Road Builders", "Big Landowners", "Businessmen", "Stock Companies", "___", "___", "___"], ["on Journeys", "Pressed for Time", "with a Bias to Individualism", "with Potential for Violence", "on the Way to the Unknown", "with Connections", "Craving for Recognition", "with Production Needs", "by External Financing", "___", "___", "___"]];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _FLinks = __webpack_require__(186);
	...
	var Link = _react2.default.createClass({
		displayName: 'Link',
		getRulesLink: function getRulesLink(wN) {
			{/*You can only get rules for a real world (no x's).*/}
			var text = "Get rules for this world at 504rules";
			return _react2.default.createElement(
				'li',
				null,
				_react2.default.createElement(
		...
		getRatingsLink: function getRatingsLink(wN, wT) {
			{/*You can link to the ratings site with a real world or partial world but not a weird world (no x's followed by digits).*/}
			var link = "http://504-2f.de/?page_id=" + _FLinks.links[parseInt(wN, 10)];
			var pluralize = "this world";
			if (wT != "full") pluralize = "these worlds";
			var text = "Rate " + pluralize + " at the official 504 site";
			return _react2.default.createElement(
				'li',
				null,
				_react2.default.createElement(
					'a',
					{ href: link, title: text },
					_react2.default.createElement(
						'span',
						{ className: 'short' },
						'Ratings'
		...
		getBggLink: function getBggLink(wN, wT) {
			{/*You can get any world from BGG.*/}
			var tagLink = "https://boardgamegeek.com/tag/504%3A" + wN + "/";
			var searchLink = "https://boardgamegeek.com/spsearch.php?objectid=175878&objecttype=thing&searchfield=all&displayresults=excerpt&q=" + wN;
			var pluralize = "this world";
			if (wT != "full") pluralize = "these worlds";
			var text = "Search for " + pluralize + " at BoardGameGeek";
			var tagCount = _Tags.tags[wN] ? _Tags.tags[wN] : 0;
			return _react2.default.createElement(
				'li',
				null,
				_react2.default.createElement(
					'a',
					{ href: searchLink, title: text },
					_react2.default.createElement(
						'span',
						{ className: 'short' },
						'BGG'
				...
				_react2.default.createElement(
					'a',
					{ href: tagLink, title: 'Search by tag' },
					'(',
					tagCount,
					' ',
		...
		getBggExtra: function getBggExtra(wN, m, flip) {
			...
			var link = "https://boardgamegeek.com/tag/504%3A" + wNew + "/";
			var text = "Search for related worlds " + wNew + " at BoardGameGeek";
			var tagCount = _Tags.tags[wNew] ? _Tags.tags[wNew] : 0;
			if (wNew != wN && wNew != "xxx" && tagCount > 0) return _react2.default.createElement(
				'a',
				{ href: link, className: 'mask', key: key, title: text },
				wNew
			);
		},
		getBggExtras: function getBggExtras(wN) {
			var _this = this;

			{/*Get masked worlds from BGG, too.*/}
			var maskList = (0, _lodash2.default)(6).map(function (m) {
				return _this.getBggExtra(wN, m);
			});
			return _react2.default.createElement(
				'li',
				null,
		...
		getStar: function getStar(num, rating) {
			var starClass = "fa fa-star-o";
			if (num * 2 <= rating) starClass = "fa fa-star";else if (num * 2 == rating + 1) starClass = "fa fa-star-half-o";
			return _react2.default.createElement('i', { className: starClass, key: num });
		},
		getStars: function getStars(wN, wT) {
			var _this2 = this;

			{/*Express the rating with stars.*/}
			var stars = 0;
			if (wT == "full" && _Ratings.ratings[wN]) stars = _Ratings.ratings[wN];
			var starList = (0, _lodash2.default)(5).map(function (n) {
				return _this2.getStar(n + 1, stars);
			});
			return _react2.default.createElement(
				'li',
				{ title: stars == 0 ? "Unrated" : "Rating" },
				starList
			);
		},
		render: function render() {
			...
			var world = _props.world;
			var worldNo = _props.worldNo;
			var worldType = _props.worldType;
