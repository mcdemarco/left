...
The source code is [here](/games/hive/bookmarklet.js), [here](/games/hive/bookmarklet-reflected.js), and [here](/games/hive/bookmarklet-rotating.js), respectively.  You can put it into a [bookmarklet editor](https://chriszarate.github.io/bookmarkleter/) to change it up and make your own bookmarklet, or just to take a look at what it does.  (If you want to get the source code out of a particular bookmarklet, use a [URL decoder](https://meyerweb.com/eric/tools/dencoder/).)
