...
See below for further installation and use instructions, which apply to all bookmarklets.
...
The source code is [here](/games/hive/bookmarklet.js) and [here](/games/hive/bookmarklet-reflected.js), respectively.  You can put it into a [bookmarklet editor](https://chriszarate.github.io/bookmarkleter/) to change it up and make your own bookmarklet, or just to take a look at what it does.

I plan to make another to rotate the grid, as soon as I find or have a clever idea about how to do it.
